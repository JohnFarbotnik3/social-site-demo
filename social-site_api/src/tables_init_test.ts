import * as types from "social-site_types/types.js";
...
export async function test() {
	...
	const test_posts = [
		...
		{ username:"bob555", contents: [
			...
			"Tomorrow night, I will be giving a lecture in the main auditorium about the following topics:<ul><li>the self-supressing overunity of mana.</li><li>how this may explain the origin of the universe, hubble expansion, and the prevention of true singularities at the center of gravistars.</li><li>how standard-model particles cause mana in their interaction cross-section to become 'flavoured'.</li></ul>",
			"There's been an exciting new development! The details are a surprise, but in tonight's lab, we <i>may</i> be exploring photon bunching of light traveling at 2-3c. See you there!",
			"Unlike Alice, I'm quite fond of punctuation ... and not casting dangerous exchange-augmentation spells in the middle of a crowded workshop.",
		]},
	];
