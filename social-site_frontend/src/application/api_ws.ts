import { ENDPOINTS } from "social-site_types/endpoints";
import { path_ws } from "./api_config";
import { cache, is_logged_in } from "./api_cache.svelte";
import * as api_fetch from "./api_fetch";
import type { Friend, StringId } from "social-site_types/types";
import * as types from "social-site_types/types";
import { state_chat } from "./state_chat.svelte";
import { getDeferredPromise, type DeferredPromise } from "social-site_types/DeferredPromise";
